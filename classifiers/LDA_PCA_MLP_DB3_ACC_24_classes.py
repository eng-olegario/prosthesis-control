...
def create_model(dropout_rate=0.0, neurons_1 = 200):
    model = Sequential()
    model.add(Reshape((1, 60), input_shape = (input_shape,)))
...
def janelamento(df, df2, label, window, overlap):  
    ...
    for i in range (0, len(segments_0)):  
        ...
        f0 = featureKUR(segments_0[i])
        f1 = featureKUR(segments_1[i])
        f2 = featureKUR(segments_2[i])
        f3 = featureKUR(segments_3[i])
        f4 = featureKUR(segments_4[i])
        f5 = featureKUR(segments_5[i])
        f6 = featureKUR(segments_6[i])
        f7 = featureKUR(segments_7[i])
        f8 = featureKUR(segments_8[i])
        f9 = featureKUR(segments_9[i])
        f10 = featureKUR(segments_10[i])
        f11 = featureKUR(segments_11[i])
    
        g0 = featureSKEW(segments_0[i])
        g1 = featureSKEW(segments_1[i])
        g2 = featureSKEW(segments_2[i])
        g3 = featureSKEW(segments_3[i])
        g4 = featureSKEW(segments_4[i])
        g5 = featureSKEW(segments_5[i])
        g6 = featureSKEW(segments_6[i])
        g7 = featureSKEW(segments_7[i])
        g8 = featureSKEW(segments_8[i])
        g9 = featureSKEW(segments_9[i])
        g10 = featureSKEW(segments_10[i])
        g11 = featureSKEW(segments_11[i])
        
        o0 = featureLRMS(segments_0[i])
        o1 = featureLRMS(segments_1[i])
        o2 = featureLRMS(segments_2[i])
        o3 = featureLRMS(segments_3[i])
        o4 = featureLRMS(segments_4[i])
        o5 = featureLRMS(segments_5[i])
        o6 = featureLRMS(segments_6[i])
        o7 = featureLRMS(segments_7[i])
        o8 = featureLRMS(segments_8[i]) 
        o9 = featureLRMS(segments_9[i])
        o10 = featureLRMS(segments_10[i]) 
        o11 = featureLRMS(segments_11[i])
        
        b0 = featureVAR(segments_0[i])
        b1 = featureVAR(segments_1[i])
        b2 = featureVAR(segments_2[i])
        b3 = featureVAR(segments_3[i])
        b4 = featureVAR(segments_4[i])
        b5 = featureVAR(segments_5[i])
        b6 = featureVAR(segments_6[i])
        b7 = featureVAR(segments_7[i])
        b8 = featureVAR(segments_8[i])
        b9 = featureVAR(segments_9[i]) 
        b10 = featureVAR(segments_10[i])
        b11 = featureVAR(segments_11[i]) 
...
# Features com sinais EMG e ACC
        ...
        feature_total.append([r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11,     # RMS
                              b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11,     # VAR
                              v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11,     # MAV
                              w0, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11,     # WL
                              f0, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11,     # KUR
                              g0, g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11,     # SKEW
                              o0, o1, o2, o3, o4, o5, o6, o7, o8, o9, o10, o11,     # logRMS
...
#####################################################
# Exercício 1
mat1 = loadmat('ninapro_db3/S6_E1_A1.mat')
emg1 = mat1['emg']
...
# Exercício 2
mat2 = loadmat('ninapro_db3/S6_E2_A1.mat')
emg2 = mat2['emg']
...
repeticao = np.vstack((repeticao1, repeticao2))
...
lowcut = 50.0
highcut = 500.0
emg = butter_bandpass_filter(emg, lowcut, highcut, fs, order=3)
...
for i in range(len(E1_label)): 
    if  (i<= fim_rep_1[0] or
        ...
        (i> fim_rep_6[21]  and i<= fim_rep_1[22])):
    ...
    if  ((i> inicio_rep_2[0] and i<= fim_rep_2[0])  or 
        ...
        (i> inicio_rep_2[22]  and i<= fim_rep_2[22])):
    ...
    if  ((i> inicio_rep_3[0] and i<= fim_rep_3[0])  or 
        ...
        (i> inicio_rep_3[22]  and i<= fim_rep_3[22])):
    ...
    if  ((i> inicio_rep_4[0] and i<= fim_rep_4[0])  or 
        ...
        (i> inicio_rep_4[22]  and i<= fim_rep_4[22])):
    ...
    if  ((i> inicio_rep_5[0] and i<= fim_rep_5[0])  or 
        ...
        (i> inicio_rep_5[22]  and i<= fim_rep_5[22])):
    ...
    if  ((i> inicio_rep_6[0] and i<= fim_rep_6[0])  or 
        ...
        (i> inicio_rep_6[22]  and i<= fim_rep_6[22])):
...
# default: C1(12000)    C2(8500/9000)  C3(7000)     C4(13000)    C5(13000)   
...
X_val, Y_val = janelamento(df, dfa, label_train, 400, 200)
...
X_test, Y_test = janelamento(df_test, dfa_test, label_test, 400, 200)
...
# Redução com LDA
lda = LinearDiscriminantAnalysis(n_components=23)       # n_components = n_class - 1 = 11
...
# Ajustes para classificador MLP
...
"""
###################################################### 
#        Classificador MLP - VALIDAÇÃO
###################################################### 
model = KerasClassifier(build_fn=create_model, verbose=0)

batch_size = [60, 80, 100]
neurons_1 = [200, 300, 400, 600]
...
neuron = grid.best_params_['neurons_1']
dropout = grid.best_params_['dropout_rate']
epochs = 100
...
###################################################### 
#      Classificador MLP - TREINAMENTO E TESTE
###################################################### 
clf = Sequential()
clf.add(Reshape((1, 23), input_shape = (input_shape,)))
clf.add(Dense(neuron, activation = 'relu'))
...
# Treina o sistema (repetições 1, 3, 4 e 6)
    clf.fit(X_val, Y_val, batch_size=batch, epochs=epochs, validation_split=0.1, verbose=0)               
